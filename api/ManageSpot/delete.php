<?php
    ...
    */
    ...
    $manageSpot->setAttr("mid", $data->mid);
    $manageSpot->setAttr("spot", $data->spot);
    ...
    if($manageSpot->delete()) {
        echo json_encode(array('message' => 'ManageParking Successfully Deleted'));
        ...
        echo json_encode(array('message' => 'ManageParking Not Deleted'));
    }
