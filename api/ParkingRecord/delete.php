<?php
    ...
    */
    ...
    $parkingRecord->setAttr("rcd_index", $data->rcd_index);
    ...
    if($parkingRecord->delete()) {
        echo json_encode(array('message' => 'ParkingRecord Successfully Deleted'));
        ...
        echo json_encode(array('message' => 'ParkingRecord Not Deleted'));
    }
