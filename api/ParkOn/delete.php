<?php
    ...
    */
    ...
    $parkOn->setAttr("spot", $data->spot);
    $parkOn->setAttr("plate", $data->plate);
    ...
    if($parkOn->delete()) {
        echo json_encode(array('message' => 'ParkOn Successfully Deleted'));
        ...
        echo json_encode(array('message' => 'ParkOn Not Deleted'));
    }
