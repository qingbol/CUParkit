Own<?php
    ...
    class ManageRecord implements model_interface {
        private $conn; // The connection to the database
        private $table = "manage_record"; // The name of the table in the mySQL database
        ...
        public function create() {
            ...
            $query = "INSERT INTO " . $this->table . 
                " SET MID = :mid, Rcd_index = :rcd_index ";
        ...
        public function read_single() {
            // Create query
            $query = "SELECT * FROM " . $this->table . 
                " WHERE MID = :mid AND Rcd_index = :rcd_index ";
