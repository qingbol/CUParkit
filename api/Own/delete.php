<?php
    ...
    */
    ...
    $own->setAttr("oid", $data->oid);
    $own->setAttr("plate", $data->plate);
    ...
    if($own->delete()) {
        echo json_encode(array('message' => 'Own Successfully Deleted'));
        ...
        echo json_encode(array('message' => 'Own Not Deleted'));
    }
