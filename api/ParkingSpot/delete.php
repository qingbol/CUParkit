<?php
    ...
    */
    ...
    $parkingSpot->setAttr("spot", $data->spot);
    ...
    if($parkingSpot->delete()) {
        echo json_encode(array('message' => 'ParkingSpot Successfully Deleted'));
        ...
        echo json_encode(array('message' => 'ParkingSpot Not Deleted'));
    }
