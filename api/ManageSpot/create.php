<?php
    ...
    */
    ...
    $manageSpot->fillAttributes($data);
    
    // Create Owner entry in the database using the data model's function
    if($manageSpot->create()) {
        echo json_encode(array('message' => 'ManageParking Successfully Created'));
    } else {
        echo json_encode(array('message' => 'ManageParking Not Created',
                                'PasswordMsg' => $manageSpot->getMsg()
        ));
